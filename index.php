<?php
    // Database connection
    $conn = mysqli_connect('localhost', 'root', 'JAY@sql_7', 'sangeet', '3306');
...
<body>
		...
		<div class="container">
			<div class="banner-text">
				<div class="slider-info text-right">
					...
					<p class="text-white">Singer? Musician? Let the world hear your art!!!.</p>
			...
			<div class="col-lg-6 abbot-right px-md-5  py-lg-0 py-3">
				<div class="card">
					<div class="card-body px-lg-5">
						<h3 class="stat-title card-title align-self-center mb-sm-5 mb-3">Sangeet
							<br> get addicted to music</h3>
						<span class="w3-line"></span>
						<p class="card-text align-self-center my-4 text-white">
							Are you a singer or musician?...But too anxious to sing in front of a huge crowd? Just upload your songs to Sangeet and let the people listen to your songs and rate it.
						</p>
						<p class="card-text align-self-center mb-5 text-white">Be the part of Sangeet.Upload your songs and get featured by greate musicians.</p>
	...
	<div class="contact-top text-center" id="more_info">
		<div class="content-contact-top">
			...
			<p class="text-white w-75 mx-auto">Sangeet a unique platform for upcoming singers.
			</p>
		</div>
	</div>
	<!-- //contact top -->
					...
					<div class="fv3-contact">
						<div class="row">
							...
							<div class="col-10">
								<h6>email</h6>
								<p>
									<a href="mailto:example@email.com" class="text-dark">jay.221943101@vcet.edu.in</a>
								</p>
							</div>
						</div>
					</div>
	...
	<div class="cpy-right text-center">
		<p>© 2024 Sangeet. No rights reserved</p>
	</div>
	<!-- //copyright -->
